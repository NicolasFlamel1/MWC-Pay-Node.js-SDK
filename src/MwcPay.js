...
class MwcPay {
	...
	*/
	async createPayment(price, requiredConfirmations, timeout, completedCallback, receivedCallback = null, confirmedCallback = null, expiredCallback = null) {
		...
		// Check if parameters are invalid
		if((typeof price !== "string" && price !== null) || (typeof requiredConfirmations !== "number" && requiredConfirmations !== null) || (requiredConfirmations !== null && Number.isInteger(requiredConfirmations) === false) || (typeof timeout !== "number" && timeout !== null) || (timeout !== null && Number.isInteger(timeout) === false) || typeof completedCallback !== "string" || (typeof receivedCallback !== "string" && receivedCallback !== null) || (typeof confirmedCallback !== "string" && confirmedCallback !== null) || (typeof expiredCallback !== "string" && expiredCallback !== null)) {
	...
	*/
	async getPaymentInfo(paymentId) {
		...
		if(typeof paymentInfo !== "object" || paymentInfo === null || "url" in paymentInfo === false || typeof paymentInfo["url"] !== "string" || paymentInfo["url"] === "" || "price" in paymentInfo === false || (paymentInfo["price"] !== null && typeof paymentInfo["price"] !== "string") || (paymentInfo["price"] !== null && paymentInfo["price"].match(/^(?:0(?:\.\d+)?|[1-9]\d*(?:\.\d+)?)$/u) === null) || "required_confirmations" in paymentInfo === false || typeof paymentInfo["required_confirmations"] !== "number" || Number.isInteger(paymentInfo["required_confirmations"]) === false || paymentInfo["required_confirmations"] <= 0 || "received" in paymentInfo === false || typeof paymentInfo["received"] !== "boolean" || "confirmations" in paymentInfo === false || typeof paymentInfo["confirmations"] !== "number" || Number.isInteger(paymentInfo["confirmations"]) === false || paymentInfo["confirmations"] < 0 || paymentInfo["confirmations"] > paymentInfo["required_confirmations"] || "time_remaining" in paymentInfo === false || (paymentInfo["time_remaining"] !== null && typeof paymentInfo["time_remaining"] !== "number") || (paymentInfo["time_remaining"] !== null && Number.isInteger(paymentInfo["time_remaining"]) === false) || (paymentInfo["time_remaining"] !== null && paymentInfo["time_remaining"] < 0) || "status" in paymentInfo === false || typeof paymentInfo["status"] !== "string" || "recipient_payment_proof_address" in paymentInfo === false || typeof paymentInfo["recipient_payment_proof_address"] !== "string" || paymentInfo["recipient_payment_proof_address"] === "") {
